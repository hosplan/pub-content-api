        ...
        httpSecurity.httpBasic(HttpBasicConfigurer::disable)
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                ...
                                .requestMatchers("conts/task/**", "conts/board/**", "conts/status/**", "conts/boardTaskMap/**", "conts/taskMemberMap/**", "conts/member/**", "conts/trashBasket/**").hasAnyAuthority("USER", "TEMPUSER")
                                .anyRequest().denyAll()
                )
